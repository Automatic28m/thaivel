...
export default function Navbar() {
    ...
    const navItems = [
        ...
        { id: "Attractions", name: "Attractions", link: "/attractions" },
            ...
            >
                ...
                <div className="flex">
                    <input
                        ...
                        onChange={(e) => setKeyword(e.target.value)}
                        onKeyDown={(e) => e.key === 'Enter' && handleSearch()}
                        className="w-full px-10 text-secondary bg-transparent tracking-widest text-xl font-serif border-3 border-secondary py-3 uppercase outline-none"
                    />
                    <button className="text-secondary cursor-pointer hover:scale-110 transition-transform" onClick={handleSearch}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
