  ...
  return (
    <div className="grid grid-cols-12 gap-3 md:gap-12">
      ...
      {attractions.map((item, i) => (
        <Fade className="aspect-9/16 w-full col-span-6 md:col-span-4 relative flex flex-col justify-end p-3 md:p-6 overflow-hidden group shadow-lg" key={item.id} delay={300 + (i * 100)}>
          <Link
